...
const RecurrenceEditModal = ({ isOpen, onClose, onConfirm, verb = 'edit' }) => {
    ...
    return (
        ...
        >
            <div 
                className="bg-slate-800 rounded-xl shadow-2xl w-full max-w-sm p-6 transform transition-all animate-in fade-in-0 zoom-in-95 duration-200"
                onClick={e => e.stopPropagation()}
            >
                <div className="flex items-start gap-4">
                    <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-indigo-900/50">
                ...
                <div className="mt-6 flex flex-col gap-3">
                    <button
                        type="button"
                        className="w-full inline-flex justify-center rounded-lg border-2 border-slate-600 bg-slate-700/60 px-4 py-3 text-base font-medium text-white hover:bg-slate-700 transition-colors"
